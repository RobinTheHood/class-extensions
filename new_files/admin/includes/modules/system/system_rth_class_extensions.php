...
/**
 * Look at the file rth_class_extensions_with_std_module.php file for a variant
 ...
 */
class system_rth_class_extensions
{
    /** @var string $prefix **/
    public $prefix;
    ...
    {
        // The value of $this->prefix is: MODULE_SYSTEM_RTH_CLASS_EXTENSIONS
